...
import servlet.TopKNextServlet;
...
@WebServlet(name = "TopKNextPlaceJsonServlet", urlPatterns = {"/json/top-k-next-places"})
public class TopKNextPlaceJsonServlet extends HttpServlet{
...
/**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String semanticPlaceName = request.getParameter("semantic_place");
        String datetime = DAOUtility.formatDatetime(request.getParameter("datetime"));
        ...
        JsonArray topKNextPlace = new JsonArray();
        ...
        // Get all macaddresses with latest updates during time window at the specified semantic place
        ...
        request.setAttribute("semanticPlace", semanticPlaceName);
